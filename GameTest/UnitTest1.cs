            ...
            var builder = new WebHostBuilder().
                ...
                ConfigureServices(service =>
                {
                    var context = new ApplicationDbContext(new DbContextOptionsBuilder<ApplicationDbContext>()
                        .UseSqlServer("Data Source=ITT-ABHIJEETS\\SQLEXPRESS;Database=TicTacToeDb;Trusted_Connection=True;MultipleActiveResultSets=true;Encrypt=yes;TrustServerCertificate=True")
